...
const db = new better_sqlite3_1.default(path_1.default.join(__dirname, '../../whalu_protocol.db'));
...
const fuchiData = db.prepare('SELECT COUNT(*) as count FROM fuchi_milestones').get();
